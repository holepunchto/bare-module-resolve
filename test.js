...
test('bare specifier with packge.json#imports', (t) => {
  ...
  for (const resolution of resolve(
    'f',
    new URL('file:///a/b/node_modules/d/e.js'),
    { extensions: ['.js'] },
    readPackage
  )) {
    result.push(resolution.href)
...
test('relative specifier with scoped package.json#exports', (t) => {
  ...
  t.alike(result, ['file:///a/b/d', 'file:///a/b/d.js', 'file:///a/b/d/e.js'])
})
...
test('absolute specifier', (t) => {
  ...
  t.alike(result, ['file:///d', 'file:///d.js', 'file:///d/index.js'])
})
...
test('absolute specifier, Windows path with drive letter', (t) => {
  ...
  for (const resolution of resolve('c:\\d', new URL('file:///a/b/c'), {
    extensions: ['.js']
  })) {
    result.push(resolution.href)
  }

  t.alike(result, ['file:///c:/d', 'file:///c:/d.js', 'file:///c:/d/index.js'])
})
...
test('package.json#main in module with trailing slash', (t) => {
  ...
  t.alike(result, ['file:///a/b/node_modules/d/e/index.js'])
})
...
test('engines with valid range', (t) => {
  ...
  for (const resolution of resolve(
    'd',
    new URL('file:///a/b/c'),
    { extensions: ['.js'], engines: { foo: '1.2.4' } },
    readPackage
  )) {
    result.push(resolution.href)
  }
...
test('package scope lookup with resolutions map', (t) => {
  ...
  for (const scope of resolve.lookupPackageScope(new URL('file:///a/b/c'), {
    resolutions
  })) {
